...
fun AgeScreen(
    ...
    onNextClick: () -> Unit, // the navigation event instead of the whole navGraph
    ...
    LaunchedEffect(key1 = true) {
        viewModel.uiEvent.collect { event ->
            when (event) {
                is UiEvent.Success -> onNextClick.invoke() // this event is a callback managed in mainActivity
