...
class TrackerRepositoryImpl(
    ...
    override suspend fun insertTrackedFood(food: TrackedFood) {
        dao.insertTrackedFood(food.toTrackedFoodEntity()) // maps result to database entity table
    }

    override suspend fun deleteTrackedFood(food: TrackedFood) {
        dao.deleteTrackedFood(food.toTrackedFoodEntity()) // maps result to database entity table
    }
    ...
    override fun getFoodsForDate(localDate: LocalDate): Flow<List<TrackedFood>> {
        return dao.getFoodsForDate(
            ...
            entities.map { it.toTrackedFood() } // maps result to domain model that does not contains android specific dependencies
        }
    }
